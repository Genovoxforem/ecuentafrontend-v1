                                ...
                                <div className="reports-entries-scroll flex-1 min-h-0 overflow-x-auto rounded-lg border border-gray-200 dark:border-slate-700 overflow-y-auto soft-scrollbar">
                                    <table className="w-full h-full text-xs">
                                        ...
                                        <tbody>
                                            ...
                                            {/* Absorbs whatever height the table's own rows don't use (table is
                                                h-full to fill the scroll panel) — without it, a short entry list
                                                leaves the Total row floating right under the last row with dead
                                                space beneath it instead of sitting flush at the panel's bottom. */}
                                            <tr aria-hidden="true">
                                                <td colSpan={14} className="h-full p-0" />
                                            </tr>
                                        </tbody>
