        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-left text-xs text-text-faint uppercase tracking-wide border-b border-border bg-surface">
              ...
              <th className="font-medium px-4 py-2.5">Contract</th>
              <th className="font-medium px-4 py-2.5">Service</th>
              <th className="font-medium px-4 py-2.5">Third-Party</th>
              <th className="font-medium px-4 py-2.5">Planned Start Date</th>
              <th className="font-medium px-4 py-2.5">Real Start Date</th>
              <th className="font-medium px-4 py-2.5">Planned End Date</th>
              <th className="font-medium px-4 py-2.5">Real End Date</th>
          ...
          <tbody>
            {services.length === 0 ? (
              <tr>
                <td colSpan={9} className="px-4 py-4 text-text-faint italic">
