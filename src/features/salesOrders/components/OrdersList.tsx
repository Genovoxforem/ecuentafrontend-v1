      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <Card className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-text-faint mt-1">All order records</p>
          </div>
        ...
        <Card className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-2xl font-bold text-text! mt-1">{fmtZMW(summary.totalOrderAmount)}</p>
            <p className="text-xs text-text-faint mt-1">Total order value</p>
          </div>
