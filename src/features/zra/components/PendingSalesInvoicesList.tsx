...
import { usePendingSalesList } from '../zraLists.queries'
...
export function PendingSalesInvoicesList() {
  ...
  const { data, isLoading, isError, error } = usePendingSalesList({ page, perPage: PER_PAGE, search })
        ...
        <table className="w-full text-sm">
          <thead className="sticky top-0 z-10 bg-surface-alt">
            <tr className="text-left text-xs text-text-faint uppercase tracking-wide border-b border-border">
              ...
              <th className="font-medium px-3 py-3">City</th>
